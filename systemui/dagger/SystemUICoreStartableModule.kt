...
import com.android.systemui.air_quality.AirQualityUI
...
abstract class SystemUICoreStartableModule {
    ...
    /** Inject into AirQualityUI.  */
    @Binds
    @IntoMap
    @ClassKey(AirQualityUI::class)
    abstract fun bindAirQualityUI(sysui: AirQualityUI): CoreStartable
